...
const filters = [
  { label: 'Present', color: 'danger', className: 'form-check-danger mb-1' },
  { label: 'Absent', color: 'primary', className: 'form-check-primary mb-1' },
  { label: 'Total Attandance', color: 'warning', className: 'form-check-warning mb-1' }
]

const SidebarLeft = props => {
  // ** Props
  const { handleAddEventSidebar, toggleSidebar, updateAllFilters, dispatch } = props
